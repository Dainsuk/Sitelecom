...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Título
        $this->Cell(75);
        $this->Cell(30, 30, 'Miscelaneo Asignado', 0, 0, 'C');
        // Salto de línea
        $this->Ln(20);
        //tabla 1
        $this->Cell(122, 10, 'Descripcion de Miscelaneo', 1, 0, 'c', 0);
...
$consulta = "SELECT * FROM asig_miscelaneo where encargado='$encargado'";
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(122, 8, utf8_decode($row['Descri_Misce']), 1, 0, 'c', 0);
    $pdf->Cell(25, 8, utf8_decode($row['cantidad_Misce']), 1, 0, 'c', 0);
    $pdf->Cell(50, 8, utf8_decode($row['encargado']), 1, 1, 'c', 0);
}

// Resultados de tabla2
