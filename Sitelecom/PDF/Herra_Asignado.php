...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Título
        $this->Cell(75);
        $this->Cell(30, 30, 'Herramienta Asignada', 0, 0, 'C');
        // Salto de línea
        $this->Ln(20);
        //tabla 1
        $this->Cell(122, 10, 'Descripcion de Herramienta', 1, 0, 'c', 0);
...
$consulta = "SELECT * FROM asig_herramienta where encargado='$encargado'";
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(122, 8, utf8_decode($row['Descri_Herra']), 1, 0, 'c', 0);
    $pdf->Cell(25, 8, utf8_decode($row['cantidad_Herra']), 1, 0, 'c', 0);
